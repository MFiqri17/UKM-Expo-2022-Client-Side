...
export default function FilosofiWarnaCarousel() {
  return (
    <Swiper
      ...
      className='mySwiper'
    >
      <div className='absolute right-0 z-50 -translate-y-48'>
        <div className='relative h-24 w-24'>
          <Image src='/images/lotus-4.svg' alt='lotus-flower' layout='fill' />
        </div>
      </div>
      <div className='absolute left-0 z-50 -translate-y-48'>
        <div className='relative h-24 w-24'>
          <Image src='/images/lotus-3.svg' alt='lotus-flower' layout='fill' />
        </div>
      </div>
      <SwiperSlide>
        <div className='m-1 flex flex-1 space-x-0 rounded-xl bg-ccream p-4 md:m-24 md:space-x-48 md:p-24'>
          ...
          <div className='basis-1/2'>
            <h3 className='mb-4 bg-gradient-to-r from-[#FAD0B6] to-[#EE7F80] bg-clip-text pb-4 text-start text-xl text-transparent md:text-7xl'>
              Bola Api
            </h3>
      ...
      <SwiperSlide>
        <div className=' m-1 flex flex-1 flex-col space-x-0 rounded-xl bg-ccream p-4 md:m-24 md:flex-row md:space-x-48 md:p-24'>
          ...
          <div className='basis-1/2'>
            <h3 className='mb-4 bg-gradient-to-r from-[#FAD0B6] to-[#EE7F80] bg-clip-text text-start text-xl text-transparent md:text-7xl'>
              Burung Phoenix
            </h3>
            <p className='text-sm leading-snug md:text-2xl'>
